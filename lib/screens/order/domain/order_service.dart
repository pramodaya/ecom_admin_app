...
class OrderService {
  ...
  static  Future<Stream<QuerySnapshot<Map<String, dynamic>>>> getOrderList() async {
    Stream<QuerySnapshot<Map<String, dynamic>>> snap = FirebaseFirestore.instance.collection('order').snapshots();
    return snap;
  }
